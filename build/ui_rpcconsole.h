...
public:
    ...
    {
        RPCConsole->setWindowTitle(QCoreApplication::translate("RPCConsole", "SmartCryptoTech - Debug window", nullptr));
        label_9->setText(QCoreApplication::translate("RPCConsole", "SmartCryptoTech Core", nullptr));
        ...
        openDebugLogfileButton->setToolTip(QCoreApplication::translate("RPCConsole", "Open the SmartCryptoTech debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
...
#if QT_CONFIG(tooltip)
        showCLOptionsButton->setToolTip(QCoreApplication::translate("RPCConsole", "Show the SmartCryptoTech-Qt help message to get a list with possible SmartCryptoTech command-line options.", nullptr));
#endif // QT_CONFIG(tooltip)
