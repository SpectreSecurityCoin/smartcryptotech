...
public:
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QCoreApplication::translate("AddressBookPage", "These are your SmartCryptoTech addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", nullptr));
...
#if QT_CONFIG(tooltip)
        signMessage->setToolTip(QCoreApplication::translate("AddressBookPage", "Sign a message to prove you own a SmartCryptoTech address", nullptr));
#endif // QT_CONFIG(tooltip)
        signMessage->setText(QCoreApplication::translate("AddressBookPage", "Sign &Message", nullptr));
#if QT_CONFIG(tooltip)
        verifyMessage->setToolTip(QCoreApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified SmartCryptoTech address", nullptr));
#endif // QT_CONFIG(tooltip)
