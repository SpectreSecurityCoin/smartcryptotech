...
public:
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically start SmartCryptoTech after logging in to the system.", nullptr));
#endif // QT_CONFIG(tooltip)
        bitcoinAtStartup->setText(QCoreApplication::translate("OptionsDialog", "&Start SmartCryptoTech on system login", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QCoreApplication::translate("OptionsDialog", "&Main", nullptr));
#if QT_CONFIG(tooltip)
        mapPortUpnp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the SmartCryptoTech client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_CONFIG(tooltip)
        mapPortUpnp->setText(QCoreApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the SmartCryptoTech network through a SOCKS5 proxy (e.g. when connecting through Tor).", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        lang->setToolTip(QCoreApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting SmartCryptoTech.", nullptr));
#endif // QT_CONFIG(tooltip)
