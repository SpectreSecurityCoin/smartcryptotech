...
public:
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. SZFPLNkyK6w3UgpweVapFfCVABHYGKyMvv)", nullptr));
...
#if QT_CONFIG(tooltip)
        signMessageButton_SM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this SmartCryptoTech address", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        addressIn_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. SZFPLNkyK6w3UgpweVapFfCVABHYGKyMvv)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        verifyMessageButton_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified SmartCryptoTech address", nullptr));
#endif // QT_CONFIG(tooltip)
