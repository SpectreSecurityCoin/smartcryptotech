...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        topLayout->setContentsMargins(0, 3, 5, 3);
...
"border-radius: 5px;"));
        ...
        labelBalance->setText(QString::fromUtf8("0 SCT"));
        ...
        labelStake->setText(QString::fromUtf8("0 SCT"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 SCT"));
        ...
        labelImmature->setText(QString::fromUtf8("0 SCT"));
...
"border-radius: 5px;"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QCoreApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SmartCryptoTech network after a connection is established, but this process has not completed yet.", nullptr));
...
#if QT_CONFIG(tooltip)
        labelTransactionsStatus->setToolTip(QCoreApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SmartCryptoTech network after a connection is established, but this process has not completed yet.", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
